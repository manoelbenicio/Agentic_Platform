...
Intel system is disabled. To activate:
  ...
  node D:/root/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node D:/root/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node D:/root/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node D:/root/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: D:/root/.codex/get-shit-done/bin/gsd-tools.cjs
